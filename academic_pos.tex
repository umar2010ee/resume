...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Electrical and Computer Engineering  }{Aug 2018 -- PRESENT}
    \resumeSubheading
      {University of Engineering and Technology, Lahore}{Lahore, Pakistan}
      {Bachelor of Science in Electrical Engineering;  GPA: 3.43}{Aug 2010 -- Jun 2014}
...
\section{Technical Skills}
  \resumeSubHeadingListStart
    \item{
      \textbf{Languages}{: \textsc{C/C++}, \textsc{Java}, Python, Assembly\textsc {(ARM, PowerPC)}, {MATLAB}}
%      \hfill
%      \textbf{Technologies}{: AWS, Play, React, Kafka, GCE}
    }
    \item{
      \textbf{Tools \& Frameworks}{: Eclipse (with plugin dev), OpenCV, TensorFlow, Klocwork, Tortoise SVN, Embunit, Jenkins, GitLab, Makefile, Maven, Jira, Confluence}
    }
   \item{
      \textbf{Debuggers}{: Lauterbauch Trace32, \textsc{IAR}, Keil uVision}
    }
   \item{
      \textbf{Hardware Platforms}{: \textsc{Arm} Cortex-M/R/A, TriCore, \textsc{PowerPC}, RH850, BeagleBoard-xM, Raspberry Pi}
    }
  \resumeSubHeadingListEnd
